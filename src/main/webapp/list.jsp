...
<body>
	...
	<c:forEach items="${request.heroList }" var="hero">
		<tr>
			...
			<td>
				<a href="modifyHero.jsp?id=${hero.id}">修改</a>&nbsp;&nbsp;&nbsp;
				<a href="delhero?id=${hero.id}" >删除</a>&nbsp;&nbsp;&nbsp;
				<a href="addHero.jsp" >增加</a>
			</td>
		</tr>
	</c:forEach>
	...
	<a href="http://localhost:8080/2018_08_17_ssh_w/showhero?page=1">首页</a>
	...
	<a href="http://localhost:8080/2018_08_17_ssh_w/showhero?page=${maxPage }">末页</a>
